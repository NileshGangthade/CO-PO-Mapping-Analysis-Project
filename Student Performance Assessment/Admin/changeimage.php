                    ...
                    <div class="card alert">
                        <div class="card-body">
                            <form name="" method="post" action="" enctype="multipart/form-data">
                                <?php
                                    $eid=$_GET['editid'];
$sql="SELECT tblcourse.ID as cid,tblcourse.BranchName,tblcourse.CourseName,teachers_data.ID,teachers_data.EmpID,teachers_data.FirstName,teachers_data.LastName,teachers_data.MobileNumber,teachers_data.Email,teachers_data.Dob,teachers_data.CourseID,teachers_data.Password,teachers_data.ProfilePic from teachers_data join tblcourse on tblcourse.ID=teachers_data.CourseID where teachers_data.ID=$eid";
