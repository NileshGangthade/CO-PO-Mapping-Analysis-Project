...
$sql="SELECT tblsuballocation.ID as suballid,tblsuballocation.CourseID,tblsuballocation.Teacherempid,tblsuballocation.Subid, tblsuballocation.academic_year, tblsuballocation.AllocationDate, teachers_data.ID, teachers_data.EmpID,teachers_data.FirstName,teachers_data.LastName,tblcourse.BranchName,tblcourse.CourseName,tblsubject.ID,tblsubject.CourseID,tblsubject.SubjectFullname,tblsubject.SubjectShortname,tblsubject.SubjectCode from tblsuballocation join teachers_data on teachers_data.ID=tblsuballocation.Teacherempid join tblcourse on tblcourse.ID=tblsuballocation.CourseID join tblsubject on tblsubject.ID=tblsuballocation.Subid where tblcourse.ID = $courseId && teachers_data.EmpID like '$sdata%' || teachers_data.FirstName like '$sdata%' || teachers_data.LastName like '$sdata%' || tblsubject.SubjectFullname like '$sdata%'";
