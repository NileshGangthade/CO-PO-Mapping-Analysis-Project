...
sa.Teacherempid,
s.SubjectFullname,
td.EmpID AS TeacherEmpID,
td.FirstName AS TeacherFirstName,
td.LastName AS TeacherLastName
FROM 
enrolled_classes ec
INNER JOIN 
...
INNER JOIN 
teachers_data td ON sa.Teacherempid = td.ID
WHERE 
ec.CourseID = ?
ORDER BY 
...
{               ?>
                                                <tr>
                                                        ...
                                                        <td><?php echo htmlentities($row->TeacherFirstName ); ?> <?php echo htmlentities($row->TeacherLastName); ?> (<?php echo htmlentities($row->TeacherEmpID); ?>)</td>
